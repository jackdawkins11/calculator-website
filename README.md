...
* Set up the database. Create a MySQL user and put its username and password into the `backend/config.php` file in this repository. Run the command `php install.php`
